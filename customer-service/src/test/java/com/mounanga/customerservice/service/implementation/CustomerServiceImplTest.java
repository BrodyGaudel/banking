...
class CustomerServiceImplTest {
    ...
    void testGetAllCustomers() {
        ...
        CustomerPageResponseDTO responseDTO = customerService.getAllCustomers(page, size);

        // Assertions
        assertNotNull(responseDTO);
        assertEquals(customerPage.getTotalPages(), responseDTO.totalPage());
        assertFalse(responseDTO.customers().isEmpty());
        assertEquals(2,responseDTO.customers().size());
    }
    ...
    void testSearchCustomers() {
        ...
        // Call the method under test
        CustomerPageResponseDTO responseDTO = customerService.searchCustomers(keyword, page, size);
